...
REF_SIZE = 2000 
POISON_FRACTION = 0.20        # attacker poison fraction
ATTACKER_EPOCHS = 8            # attacker local epochs
...
if __name__ == "__main__":
    for r in range(1, ROUNDS + 1):
        ...
        for i in sampled:
            ...
            epochs = ATTACKER_EPOCHS if i == ATTACKER_IDX else LOCAL_EPOCHS
            train_local(base, client_loaders[i], epochs=epochs, lr=LR_HEAD)
